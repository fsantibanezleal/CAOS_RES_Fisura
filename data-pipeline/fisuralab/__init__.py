"""fisuralab, the offline+live engine for the CAOS product-repo template (ADR-0057).
...
__version__ = "0.21.000"  # display X.XX.XXX; PEP 440 form in pyproject.toml (0.9.0)
