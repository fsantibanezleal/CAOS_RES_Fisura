// LIVE lane (optional, Pyodide): load the inlined fisuralab sources (public/pyodide/sources.json) and call
// fisuralab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB, a real
