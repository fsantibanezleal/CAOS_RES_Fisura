...
export const PLANNED_CASES: PlannedCase[] = [
  ...
  { id: 'crackseg9k-ladder', track: 'learned', status: 'todo', en: 'CrackSeg9k learned ladder', es: 'Escalera aprendida CrackSeg9k', data_en: 'U-Net, DeepLabV3+, SegFormer-B2, HrSegNet, CrackFormer-II', data_es: 'U-Net, DeepLabV3+, SegFormer-B2, HrSegNet, CrackFormer-II' },
  ...
  { id: 'width-bench', track: 'quantify', status: 'todo', en: 'Width measurement bench', es: 'Banco de medición de ancho', data_en: 'Synthetic ground truth + dual estimators + calibration to mm', data_es: 'Ground truth sintético + estimadores duales + calibración a mm' },
  { id: 'severity-grading', track: 'quantify', status: 'todo', en: 'Severity context', es: 'Contexto de severidad', data_en: 'Width percentiles against published guidance bands, caveats carried', data_es: 'Percentiles de ancho contra bandas de guías publicadas, con sus caveats' },
