...
export const PLANNED_CASES: PlannedCase[] = [
  ...
  { id: 'learned_on_examples', track: 'learned', status: 'replay', en: 'Learned ladder A on the examples', es: 'Escalera aprendida A en los ejemplos', data_en: 'Four trained models + a DINOv2 frozen-feature probe on the same committed patches as the classical ladder', data_es: 'Cuatro modelos entrenados + una sonda DINOv2 de features congeladas sobre los mismos parches que la escalera clásica' },
  { id: 'foundation-adapters', track: 'foundation', status: 'building', en: 'Foundation adapters', es: 'Adaptadores fundacionales', data_en: 'DINOv2 linear probe shipped (385-param head, F1@5px 0.62); SAM LoRA + norm-only tuning next', data_es: 'Sonda lineal DINOv2 lista (cabeza 385 params, F1@5px 0.62); SAM LoRA + ajuste de normalización siguen' },
  { id: 'dacl10k-damage', track: 'multiclass', status: 'building', en: 'dacl10k bridge damage', es: 'Daño de puentes dacl10k', data_en: '19-class multi-label segmentation trained (EffB4-FPN); measured mIoU 0.117 vs 0.424 baseline on a reduced budget, see Multi-class', data_es: 'Segmentación multietiqueta de 19 clases entrenada (EffB4-FPN); mIoU medido 0.117 vs 0.424 de la línea base con presupuesto reducido, ver Multiclase' },
  { id: 'codebrim-detect', track: 'multiclass', status: 'todo', en: 'CODEBRIM detection', es: 'Detección CODEBRIM', data_en: 'Damage bounding boxes with permissive detectors (Faster R-CNN, RT-DETR); code ready, pending a complete dataset download', data_es: 'Cajas de daño con detectores de licencia permisiva (Faster R-CNN, RT-DETR); código listo, pendiente una descarga completa del dataset' },
  ...
  { id: 'anomaly-concrete', track: 'anomaly', status: 'building', en: 'Anomaly on concrete', es: 'Anomalías en hormigón', data_en: 'PatchCore fit on uncracked concrete, AUROC 0.72 on cracked-vs-uncracked (Benchmark page); the head-to-head the literature lacked', data_es: 'PatchCore ajustado en hormigón sin grieta, AUROC 0.72 con-vs-sin grieta (página Benchmark); el head-to-head que faltaba' },
  ...
  { id: 'growth-monitoring', track: 'monitor', status: 'building', en: 'Growth between epochs', es: 'Crecimiento entre épocas', data_en: 'ORB + RANSAC registration + differential crack mapping; validated on a synthetic pair (0.095 mm width growth recovered vs exact GT), see Monitoring', data_es: 'Registro ORB + RANSAC + mapeo diferencial de grietas; validado en un par sintético (0.095 mm de crecimiento recuperado vs GT exacto), ver Monitoreo' },
  { id: 'dic-deformation', track: 'monitor', status: 'building', en: 'DIC deformation', es: 'Deformación DIC', data_en: 'In-repo 2D subset DIC (ZNCC); a known deformation recovered to 0.026 px on speckle, crack-opening as a displacement discontinuity, see Monitoring', data_es: 'DIC 2D de subconjuntos en el repo (ZNCC); una deformación conocida recuperada a 0.026 px en moteado, apertura de grieta como discontinuidad de desplazamiento, ver Monitoreo' },
];
